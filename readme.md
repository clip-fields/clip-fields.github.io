...
Once you have the dependencies installed, you can run the training script `train.py` with any [.r3d](https://record3d.app/) files that you have! If you just want to try out a sample, download some [sample data](https://osf.io/famgv) `nyu.r3d` freely available online and run the following command.
